...
Context::Context(const std::string &name, JSRuntime *parent_rt, NativeInterface *native) : name(name), qjs_context(JS_NewContext(parent_rt)), native_interface(native) {
