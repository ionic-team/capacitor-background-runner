...
Java_io_ionic_android_1js_1engine_Context_destroyContext(JNIEnv *env, jobject thiz, jlong ptr) {
    auto *ctx = (Context *)ptr;
    delete ctx;
}
extern "C"
JNIEXPORT jstring JNICALL
Java_io_ionic_android_1js_1engine_Context_evaluate(JNIEnv *env, jobject thiz, jlong ptr,
                                                   jstring code, jboolean ret_value) {
    auto *ctx = (Context *)ptr;
...
extern "C"
JNIEXPORT void JNICALL
Java_io_ionic_android_1js_1engine_Context_start(JNIEnv *env, jobject thiz, jlong ptr) {
    auto *ctx = (Context *)ptr;
    ctx->start_run_loop();
}
extern "C"
JNIEXPORT void JNICALL
Java_io_ionic_android_1js_1engine_Context_stop(JNIEnv *env, jobject thiz, jlong ptr) {
    auto *ctx = (Context *)ptr;
    ctx->stop_run_loop();
}
extern "C"
JNIEXPORT void JNICALL
Java_io_ionic_android_1js_1engine_Context_dispatchEvent(JNIEnv *env, jobject thiz, jlong ptr,
                                                        jstring event, jstring details) {
    auto *ctx = (Context *)ptr;
...
extern "C"
JNIEXPORT void JNICALL
Java_io_ionic_android_1js_1engine_Context_registerGlobalFunction(JNIEnv *env, jobject thiz,
                                                                 jlong ptr, jstring function_name,
                                                                 jobject function) {
