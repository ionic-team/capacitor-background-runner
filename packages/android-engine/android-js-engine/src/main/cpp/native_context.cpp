...
extern "C" JNIEXPORT jlong JNICALL Java_io_ionic_android_1js_1engine_Context_createRunnerContext(JNIEnv *env, jobject thiz, jlong runner_ptr, jstring name) {
...
extern "C" JNIEXPORT void JNICALL Java_io_ionic_android_1js_1engine_Context_setCapacitorAPI(JNIEnv *env, jobject thiz, jlong ptr, jobject api) {
  auto *ctx = (Context *)ptr;
