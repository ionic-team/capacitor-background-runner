...
Java::Java(JNIEnv *env) {
  ...
  // Context API
  tmp_class = env->FindClass("io/ionic/android_js_engine/WebAPI");
  ...
  tmp_class = env->FindClass("io/ionic/android_js_engine/JSFetchOptions");
  this->check_exception(env);

  this->js_fetch_options_class = (jclass)env->NewGlobalRef(tmp_class);
  env->DeleteLocalRef(tmp_class);
  tmp_class = nullptr;

  tmp_class = env->FindClass("io/ionic/android_js_engine/JSResponse");
  this->check_exception(env);

  this->js_response_class = (jclass)env->NewGlobalRef(tmp_class);
  env->DeleteLocalRef(tmp_class);
  tmp_class = nullptr;
  ...
  tmp_class = env->FindClass("io/ionic/android_js_engine/api/DeviceAPI");
  this->check_exception(env);
  ...
  tmp_class = env->FindClass("io/ionic/android_js_engine/api/GeolocationAPI");
  this->check_exception(env);
  ...
  tmp_class = env->FindClass("io/ionic/android_js_engine/api/NotificationsAPI");
  this->check_exception(env);
  ...
  this->web_api_fetch_method = env->GetStaticMethodID(this->web_api_class, "fetch", "(Ljava/lang/String;Lio/ionic/android_js_engine/JSFetchOptions;)Lio/ionic/android_js_engine/JSResponse;");
  this->check_exception(env);
