...
Java_io_ionic_android_1js_1engine_Runner_startRunner(JNIEnv *env, jobject thiz, jlong ptr) {
    auto* runner = (Runner *)ptr;
    runner->start();
}
extern "C"
JNIEXPORT void JNICALL
Java_io_ionic_android_1js_1engine_Runner_stopRunner(JNIEnv *env, jobject thiz, jlong ptr) {
    auto* runner = (Runner *)ptr;
    runner->stop();
}
extern "C"
