...
Java_io_ionic_backgroundrunner_Runner_00024Companion_initRunner(JNIEnv *env, jobject thiz) {
...
Java_io_ionic_backgroundrunner_Runner_00024Companion_destroyRunner(JNIEnv *env, jobject thiz, jlong ptr) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_io_ionic_backgroundrunner_Context_00024Companion_initContext(JNIEnv *env, jobject thiz, jlong runner_ptr, jstring name) {
...
extern "C"
JNIEXPORT void JNICALL
Java_io_ionic_backgroundrunner_Context_00024Companion_destroyContext(JNIEnv *env, jobject thiz, jlong ptr) {
...
Java_io_ionic_backgroundrunner_Context_00024Companion_evaluate(JNIEnv *env, jobject thiz, jlong ptr, jstring code, jboolean ret_value) {
    Context *ctx = (Context *)ptr;
...
extern "C"
JNIEXPORT void JNICALL
Java_io_ionic_backgroundrunner_Context_00024Companion_dispatchEvent(JNIEnv *env, jobject thiz, jlong ptr, jstring event, jstring details) {
    Context *ctx = (Context *)ptr;
...
extern "C"
JNIEXPORT void JNICALL
Java_io_ionic_backgroundrunner_Context_00024Companion_start(JNIEnv *env ,jobject thiz, jlong ptr) {
    Context *ctx = (Context *)ptr;
    ctx->start_run_loop();
}
extern "C"
JNIEXPORT void JNICALL
Java_io_ionic_backgroundrunner_Context_00024Companion_stop(JNIEnv *env, jobject thiz, jlong ptr) {
    Context *ctx = (Context *)ptr;
    ctx->stop_run_loop();
}
extern "C"
JNIEXPORT void JNICALL
Java_io_ionic_backgroundrunner_Context_00024Companion_registerGlobalFunction(JNIEnv *env, jobject thiz, jlong ptr, jstring function_name, jobject function) {
